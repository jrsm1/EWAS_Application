...
#     """
#     filename = Visualization.visualization_values['plot_filename']
#     if Window.validate_file_path(filename):
#
#         plot = Visualization.visualization_values['requested_plot']
#
#         if viz_selector.validate_visualize_sensor_selection(1):  # Only have to Validate One Sensor.
#             # Choose which Plot.
#             if plot == 1:
#                 plot_time(filename)
#             elif plot == 2:
...
#             viz_selector.close()
#
#         elif viz_selector_validate_visualize_sensor_selection(2):  # Requires 2 Sensors.
#             if plot == 4:
#                 plot_cps(filename)
#             elif plot == 5:
#                 plot_phase(filename)
...
# def enable_main_start_connected_sensors():
    ...
    # connected_module_list = [0, 1, 0, 0, 0, 0, 0, 0]
...
#             app.processEvents()
#             if timeout == 45:  # = [desired timeout in seconds] * [1/(sleep value)] TODO REAL 45
#                 # prog_dlg.close()
...
#             modules_all[0].channel_info['Sensor 2'] = sensors_all[1]
#             modules_all[0].channel_info['Sensor 3'] = sensors_all[2]
#             modules_all[0].channel_info['Sensor 4'] = sensors_all[3]
...
#             modules_all[1].channel_info['Sensor 5'] = sensors_all[4]
#             modules_all[1].channel_info['Sensor 6'] = sensors_all[5]
#             modules_all[1].channel_info['Sensor 7'] = sensors_all[6]
#             modules_all[1].channel_info['Sensor 8'] = sensors_all[7]
...
# def update_sensor_drop_down(): FIXME ???????????????????????
#     print('NOt YEt')
